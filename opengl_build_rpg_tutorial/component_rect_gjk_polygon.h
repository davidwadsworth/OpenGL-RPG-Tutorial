...
#define PolygonPhysicsGJK Polygon<Component::Rectangle::IPhysics<Component::Rectangle::IGJK<Component::Rectang>>>
#define PolygonActionGJK Polygon<Component::Rectangle::IGJK<Component::Rectangle::Action>>
	}
}