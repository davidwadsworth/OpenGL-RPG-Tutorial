...
namespace Component {
	namespace Rectangle {
		namespace Physics {
			...
			{
				template <typename T>
				class Smooth : public Component::Rectangle::Boundary<T>
				{
				public:
					using Component::Rectangle::Boundary<T>::Boundary;

					void resolve(Component::Rectangle::T& col) override
					{
			...
			{
				template <typename T>
				class Smooth : public Component::Rectangle::Circle<T>
				{
				public:
					using Component::Rectangle::Circle<T>::Circle;
			...
			{
				template <typename T>
				class Smooth : public Component::Rectangle::Polygon<T>
				{
				...
				public:
					Smooth(const Rect& transform, std::vector<glm::vec2> vertices)
						: Component::Rectangle::Polygon<T>(transform, vertices), shortest_magnitude_(FLT_MAX), shortest_distance_(FLT_MAX)
					{
...
#define SmoothPhysics Smooth<Component::Rectangle::IPhysics<Component::Rectangle::IGJK>>
#define SmoothPhysicsAction Smooth<Component::Rectangle::IPhysics<Component::Rectangle::GJK::Action>>
			}	
		}
	}
}